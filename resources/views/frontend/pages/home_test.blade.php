        ...
        <div class="row">
          ...
          <div class="col-lg-8 paddngrgt80" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
            <div class="text-start mb-md-4 mb-2 pt-4">
                <p class="pb-0 mb-0 pt-0" style="font-weight: 500;"><b>Salient Features</b></p>
              <h3 class="roboto text_color roboto fw-normal">TEST PAGE {!! $about_title !!}</h3>
            </div>
            {!! $about_description !!}
          </div>
        ...
        <div class="row justify-content-center">
          ...
          @foreach($home_awards['itration'] as $index => $itration)
           ...
           <div class="read-more text-center">
              <a href="{{url('awards')}}" class="btn-2">View All</a>
            </div>
        </div>
      </div>
    </section>
