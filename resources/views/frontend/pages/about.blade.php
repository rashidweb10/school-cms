        ...
        <div class="row">
            ...
            <div class="tab-content" id="pills-tabContent">
                @foreach($categories as $index => $category)
                    ...
                    <div class="tab-pane fade {{ $index == 0 ? 'show active' : '' }} @if(Str::contains(strtolower($category->name), 'desk') || $category->name == 'director') template-1 @elseif(Str::contains(strtolower($category->name), 'team')) template-2 @else template-3 @endif"
                        id="content_{{ $category->id }}" 
                        role="tabpanel" 
                        aria-labelledby="tab_{{ $category->id }}">                        
