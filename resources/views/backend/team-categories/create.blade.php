<form id="create" action="{{ route('team-categories.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <!-- Name -->
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <div class="form-group mb-2">
                ...
                <input value="" name="meta_description" type="text" class="form-control" maxlength="200">
            </div>
        </div>
