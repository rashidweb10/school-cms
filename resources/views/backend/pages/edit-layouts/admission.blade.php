        ...
        @foreach($admission['itration'] as $index => $itration)
            <div class="row remove-parent">
                <div class="col-md-12">
                    ...
                    <input value="{{ $index }}" name="meta[admission][itration][]" type="hidden" required>
                </div>    
                <div class="col-md">
                    <div class="form-group mb-2">
                        <div class="input-group" data-toggle="aizuploader" data-type="document" data-multiple="true">
                            ...
                            <input type="hidden" 
                                name="meta[admission][attachments][]" 
                                class="selected-files" 
                                value="{{ $admission['attachments'][$index] ?? '' }}" 
                                required>
                        </div>
...
<button
    ...
    data-content='
        <div class="row remove-parent">
            <div class="col-md-12">
                <label for="name" class="form-label">Attachments <span class="text-danger">*</span></label>
                <input value="data" name="meta[admission][itration][]" type="hidden" required>
            </div>   
            <div class="col-md">
                <div class="form-group mb-2">
                    <div class="input-group" data-toggle="aizuploader" data-type="document" data-multiple="true">
                        ...
                        <div class="form-control file-amount">{{ __('Choose File') }}</div>
                        <input type="hidden" name="meta[admission][attachments][]" class="selected-files" required>
                    </div>
                    <div class="file-preview box sm"></div>
                </div>
            </div>
